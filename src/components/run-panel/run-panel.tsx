...
const RunPanel = observer(() => {
    ...
    const { BOT_BUILDER, CHART, AI_SCALPER_BOTS, DCIRCLES } = DBOT_TABS;
    const has_persistent_run_panel = [AI_SCALPER_BOTS, DCIRCLES].includes(active_tab);
    ...
    const show_run_panel = [BOT_BUILDER, CHART, AI_SCALPER_BOTS, DCIRCLES].includes(active_tab) || active_tour;
