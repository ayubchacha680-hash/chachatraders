...
import { matchesRequiredBlockType } from './required-blocks';
...
export const hasAllRequiredBlocks = () => {
    ...
    const has_all_required_blocks = required_block_types.every(
        required_block_type => all_block_types.some(block_type => matchesRequiredBlockType(block_type, required_block_type))
    );
